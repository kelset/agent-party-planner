...
The **War Room** is the highest level of orchestration in the Agents Party. It serves as the meta-level interface between the human user and the underlying execution layers (the GM Session and the Party).

...
- **Headers & Display Text (Theme):**
  ...
  - _Future consideration: Introduce a web-safe pixel art font (e.g., 'Press Start 2P', 'VT323', or a custom readable pixel font) specifically for main headers like "Assemble Your Party" or "Seal The Pact"._
